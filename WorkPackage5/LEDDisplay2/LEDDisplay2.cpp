...
#ifndef LEDDisplay2_h
#define LEDDisplay2_h

#include "Arduino.h"
#include "LEDDisplay2.h"

LEDDisplay2::LEDDisplay2(int numberOfDigits, int digitFlagPins[], int segmentPins[], int decimalPointPin)
{		
...
void LEDDisplay2::displayNumber(int number, int digit, bool showDecimalPoint)
{
...
void LEDDisplay2::displayNumber(int number, int digit)
{
	this->displayNumber(number, digit, false);
}

void LEDDisplay2::displayDecimalPoint(int digit)
{
	// Set the digit we want to write to.
	for (int i = 0; i < this->digitCount; i++)
	{
