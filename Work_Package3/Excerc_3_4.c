/*
 ...
 Demonstration code: [<Examen code> <20315>]
...
void choose_SEARCH(enum CHOICE command) {
    switch (command) {
        ...
        case TWO:
            ...
            search_by_lastname(userInputLast);
            break;
        default:
            printf("INPUT ERROR \n");
            break;
...
void choose_Command(enum CHOICE command){
    switch( command ) {
        ...
        case TWO:
            printf("TWO \n");
            // create object here??
            write_new_file(filename); //missing creating the index collection
            break;
        case THREE:
            printf("THREE \n");
